...
var (
	...
	editChipLabelStyle = lipgloss.NewStyle().Foreground(colorDim)
	editChipKeyStyle   = lipgloss.NewStyle().Foreground(colorPrimary).Bold(true)
	editChipSepStyle   = lipgloss.NewStyle().Foreground(colorSubtle)
